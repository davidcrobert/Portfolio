  ...
  return (
    <PageWrapper>
      <MainContent>
        ...
        <ProjectContent>
          <CustomHeader>
            <CustomTitle>Assembly Line - Custom Content Here</CustomTitle>
            <CustomCategory>[professional project]</CustomCategory>
            <CustomSubtitle>
              Add your custom content and description for Assembly Line here.
            </CustomSubtitle>
          </CustomHeader>
          ...
          <DescriptionParagraph>
            This is a placeholder paragraph for Assembly Line.
